...
def generate_informative_relations(rng, x_true, r_target, params,
    ...
    Parameters:
        ...
        noise_level:    fraction of noise to add to z_tilde (default 0.1)
    Returns:
...
def _print_experiment_banner(args, params, beta_eff, fitness_mode,
    ...
    print(f"  Informative relations (per key): {args.inf_rels}")
    print(f"  Target total relations: {args.inf_rels * args.num_keys}")
...
Examples:
  ...
  python hillclimb_mldsa.py --params 44 --inf-rels 15000 --block-size 5 \\
    ...
    core.add_argument("--noise-level", type=float, default=0.2,
                      help="Noise level for relation generation (default: 0.2)")
    ...
    opt.add_argument("--adaptive-w-patience", type=int, default=200,
    ...
    opt.add_argument("--perturb-max", type=int, default=100,
