...
run_sweep() {
    ...
    while true; do
        local cmd="python3 ../hillclimb_mldsa_noise.py --noise-level 0.30 --params ${params} --leakage ${leakage} --num-keys 5 --patience 1000 --inf-rels ${ir} --workers 16 --seed 42 --default-optimizations --adaptive-w-max 3"
...
# ML-DSA-44
run_sweep 44 6 120000
run_sweep 44 7 240000
run_sweep 44 8 280000
#run_sweep 44 9 280000

# ML-DSA-87
run_sweep 87 6 120000
run_sweep 87 7 220000
run_sweep 87 8 400000
#run_sweep 87 9 400000

# ML-DSA-65
run_sweep 65 6 120000
run_sweep 65 7 240000
run_sweep 65 8 460000
run_sweep 65 9 740000
