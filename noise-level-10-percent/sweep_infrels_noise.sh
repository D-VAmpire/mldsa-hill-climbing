...
run_sweep() {
    ...
    while true; do
        local cmd="python3 ../hillclimb_mldsa_noise.py --noise-level 0.10 --params ${params} --leakage ${leakage} --num-keys 5 --patience 1000 --inf-rels ${ir} --workers 16 --seed 42 --default-optimizations --adaptive-w-max 3"
...
# ML-DSA-44
#run_sweep 44 6 30000
#run_sweep 44 7 60000
#run_sweep 44 8 70000
##run_sweep 44 9 70000
#
## ML-DSA-87
#run_sweep 87 6 30000
#run_sweep 87 7 55000
#run_sweep 87 8 100000
##run_sweep 87 9 100000
#
## ML-DSA-65
#run_sweep 65 6 30000
#run_sweep 65 7 60000
run_sweep 65 8 115000
run_sweep 65 9 185000
